...
\section*{SASS}
\addcontentsline{toc}{section}{SASS}
...
\addcontentsline{toc}{section}{Font and Typography}
...
\addcontentsline{toc}{section}{Colour Scheme}
...
\section*{Buttons}
\addcontentsline{toc}{section}{Buttons}
...
\addcontentsline{toc}{section}{Button Groups and Pagination}
...
\end{lstlisting}
\section*{Grid}
\addcontentsline{toc}{section}{Grid}
...
\section*{Mixins}
\addcontentsline{toc}{section}{Mixins}
...
\section*{States}
\addcontentsline{toc}{section}{States}
...
\section*{Panels}
\addcontentsline{toc}{section}{Panels}
...
\addcontentsline{toc}{section}{Engineering Release One (January, and February)}
\begin{itemize}
	...
	\addcontentsline{toc}{section}{Engineering Release Two (March)}
	...
	\end{itemize}
	\section*{Engineering Release Three (April):}
	\addcontentsline{toc}{section}{Engineering Release Three (April)}
